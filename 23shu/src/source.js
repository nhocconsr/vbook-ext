function execute(slug, page) {
    if (!page) page = '1';
    //http://www.23shu.com/type/all_0_2_lastupdate_1.html
    let response = fetch('http://www.23shu.com/type/'+slug+'_0_2_lastupdate_'+page+'.html');
    if(response.ok){
        ...
        el.forEach(e =>{
            data.push({
                ...
                description: e.select(".nickname").first().text(),
